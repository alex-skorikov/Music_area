    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
            ...
            <ul class="nav nav-pills nav-stacked">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/createmusic">Add new Music type</a></li>
        ...
        <div class="col-sm-9">
            <h2>Create new Music type</h2>

            <form action="${pageContext.request.contextPath}/createmusic" method="post"
                  name="f_update" onsubmit="return validate_form();">
                Music type : <br>
                <input type="text" name="type" value="Enter music type"><br>

                Music Description :<br>
                <textarea name="description" cols="30" rows="10">Enter Description</textarea><br>
                <br>
                <button type="submit" class="btn btn-success"
                        name="id"
                        value="${pageContext.request.contextPath}">Create Music type
                </button>
            </form>
        </div>
    </div>
