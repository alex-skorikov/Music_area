    ...
    <div class="row content">
        <div class="col-sm-3 sidenav">
            ...
            <ul class="nav nav-pills nav-stacked">
                <li class="active"><a href="list">Users List</a></li>
                <li><a href="${pageContext.request.contextPath}/create">Add new User</a></li>
            ...
            <table>
                ...
                <c:forEach items="${users}" var="user">
                    <tr style="cursor: pointer"
                        onclick="window.location.href='${pageContext.request.contextPath}/update?id=${user.id}'; return false">
                        ...
                        <td><c:out value="${user.role.role}"></c:out>
                        </td>
